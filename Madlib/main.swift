...
while begin {
    print("Welcome to the Mad Lib, please type 'Start' to begin")       //Begin "Welcome" message Runs welcome message. -Alex
    var begin1 = input()
    if begin1 == "Start" {
        print("Welcome to the Mad Lib")
        begin = false
        
        print("Please type the name a Mad Lib from one of these below")     //After begins startup selection menu. Brings up UI menu - Alex
        print("Summer Trip")
        print("Bike Riding")
        ...
        var madlib = input()                                //Where Mad Lib 1 Begins -If chosen, runs Mad Lib 1 -Alex
        if madlib == "Summer Trip" {
        print("Welcome to Mad Lib 1, 'Summer Trip'")
        print("Please type the name of a person")
        var person = input()
        
        print("Please type the name of a place")        // First command of Mad Lib 1 Is first question to run Mad lib 1 - Alex
        var place = input()
        ...
        print("Last summer, my mom and dad took me and \(person) on a trip to \(place). The weather there is very \(adj)! Northern \(place) has many \(pNoun), and they make \(adj2) \(pNoun2) there. Many people also go to \(place3) to \(aVerb) or see the \(pNoun3). The people that live there love to eat \(pNoun4) and are very proud of their big \(noun2). They also like to \(aVerb2) in the sun and swim in the \(aVerb3)! It was a really \(adj3) trip!")       //What is printed when you finish the Mad Lib. Prints Mad Lib 1 completed -Alex
            
            print("Would you like to play again?")      //Basic Play again option. If Yes, reruns UI menu. If no, ends program. -Alex
            print("Yes or no?")
            var playAgain = input()
            if playAgain == "Yes"{
            begin = true
        ...
        } else if madlib == "Bike Riding"{              //Where Mad Lib 2 Begins -If chosen, runs Mad Lib  -Alex
        print("Welcome to Mad Lib 2, 'Bike Riding'")
        
            print("Please type a verb ending with 'ing'") //First command of Mad lib 2, first question to run Mad lib 2 - Alex
        ...
        print("\(ingVerb) is a/an \(adj) form of exercise. \(ingVerb2) a bicycle enables you to develop your \(bPart) muscles as well as \(adverb) increase the rate of your \(bPart2) beat. More \(pNoun) around the world \(verb) bicycles than drive \(animals). No matter what kind of \(noun) you \(verb2), always be sure to wear a/an \(adj2) helmet. Make sure to have \(color) too!") //End of Mad lib 2. Prints Mad Lib 2 completed -Alex
        
            
        print("Would you like to play again?") //Play again option for Mad Lib 2  If Yes, reruns UI menu. If no, ends program. -Alex
        print("Yes or no?")
        var playAgain = input()
        if playAgain == "Yes"{
        begin = true
        ...
        } else if madlib == "The Family Visit" {                //Mad Lib 3 begins -If chosen, runs Mad Lib 3 -Alex
        print("Welcome to Mad Lib 3, 'The Family Visit'")
        
            print("Please type an adjective")           //First Command of Mad Lib 3, first question to run Mad lib 3 - Alex
        ...
        } else if madlib == "Ice Cream"{        //Begin of Mad lib 4 -If chosen, runs Mad Lib 4 -Alex
        print("Welcome to Mad Lib 4, 'How to make an Ice-Cream Sundae'")
        
            print("Please type a adjective") //First command fo Mad Lib 4, first question to run Mad lib 4 - Alex
        ...
        //End of Mad lib 4 with print function. Prints Mad Lib 4 completed -Alex
        ...
        //Replay option for Mad Lib 4  If Yes, reruns UI menu. If no, ends program. -Alex
            
            

        }else if madlib == "Skating"{     //Begin of Mad Lib 5 -If chosen, runs Mad Lib 5 -Alex
        print("Welcome to Mad Lib 5")
        
            print("Please type the name of a person") //First command for Mad Lib 5, first question to run Mad lib 5 - Alex
        ...
        if playAgain == "Yes"{
        begin = true
            }       //Replay option for Mad Lib 5  If Yes, reruns UI menu. If no, ends program. -Alex
